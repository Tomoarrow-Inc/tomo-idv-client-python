...
class KycContactView(BaseModel):
    """
    KycContactView
    """ # noqa: E501
    email_address: Optional[StrictStr]
    phone_number: Optional[StrictStr]
    __properties: ClassVar[List[str]] = ["email_address", "phone_number"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of KycContactView from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of KycContactView from a dict"""
        if obj is None:
            return None
