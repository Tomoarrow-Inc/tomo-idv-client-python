...
class DefaultApi:
    ...
    @validate_call
    def v1_idv_result_bulk_delete_post(
        self,
        result_bulk_delete_req: Optional[ResultBulkDeleteReq] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        """v1_idv_result_bulk_delete_post


        :param result_bulk_delete_req:
        :type result_bulk_delete_req: ResultBulkDeleteReq
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._v1_idv_result_bulk_delete_post_serialize(
            result_bulk_delete_req=result_bulk_delete_req,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def v1_idv_result_bulk_delete_post_with_http_info(
        self,
        result_bulk_delete_req: Optional[ResultBulkDeleteReq] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ResultBulkDeleteRes]:
        """v1_idv_result_bulk_delete_post
    ...
    @validate_call
    def v1_idv_result_bulk_delete_post_without_preload_content(
        self,
        result_bulk_delete_req: Optional[ResultBulkDeleteReq] = None,
        _request_timeout: Union[
            None,
    ...
    def _v1_idv_result_bulk_delete_post_serialize(
        self,
        result_bulk_delete_req,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if result_bulk_delete_req is not None:
            _body_params = result_bulk_delete_req
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/idv/result/bulk-delete',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def v1_idv_result_delete_post(
        self,
        result_delete_req: Optional[ResultDeleteReq] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        """v1_idv_result_delete_post


        :param result_delete_req:
        :type result_delete_req: ResultDeleteReq
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._v1_idv_result_delete_post_serialize(
            result_delete_req=result_delete_req,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def v1_idv_result_delete_post_with_http_info(
        self,
        result_delete_req: Optional[ResultDeleteReq] = None,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def v1_idv_result_delete_post_without_preload_content(
        self,
        result_delete_req: Optional[ResultDeleteReq] = None,
        _request_timeout: Union[
            None,
    ...
    def _v1_idv_result_delete_post_serialize(
        self,
        result_delete_req,
        _request_auth,
        _content_type,
        ...
        # process the form parameters
        # process the body parameter
        if result_delete_req is not None:
            _body_params = result_delete_req
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/idv/result/delete',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
