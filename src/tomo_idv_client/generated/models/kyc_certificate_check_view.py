...
class KycCertificateCheckView(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["outcome", "valid_from", "valid_to", "verified_at"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of KycCertificateCheckView from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of KycCertificateCheckView from a dict"""
        if obj is None:
            return None
